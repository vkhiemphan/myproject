...
<footer id="colophon" class="rsrc-footer" role="contentinfo">                
  <div class="row rsrc-author-credits">                    
    <p class="text-center">
			...
			<span class="sep"> | </span>
			<?php printf( __( 'Theme: %1$s by %2$s', 'online-store' ), '<a href="http://themes4wp.com/theme/online-store" title="' . esc_attr__( 'Free WooCommerce WordPress Theme', 'online-store' ) . '">Online Store</a>', 'Themes4WP' ); ?>
		</p>                
  </div>    
</footer>
<div id="back-top">  
