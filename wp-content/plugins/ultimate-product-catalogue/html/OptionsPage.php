...
<table id='premium-options' class="form-table upcp-options-table">
	...
	<td>
		...
		<label title='Price'><input type='checkbox' name='product_sort[]' value='Price' <?php if(in_array("Price", $Product_Sort)) {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/> <span><?php _e("Price", 'UPCP')?></span></label><br />
		<label title='Name'><input type='checkbox' name='product_sort[]' value='Name' <?php if(in_array("Name", $Product_Sort)) {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/> <span><?php _e("Name", 'UPCP')?></span></label><br />
		<label title='Rating'><input type='checkbox' name='product_sort[]' value='Rating' <?php if(in_array("Rating", $Product_Sort)) {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/> <span><?php _e("Review Ratings", 'UPCP')?></span></label><br />
		<p><?php _e("Select which sorting options are available in the 'Sort By' box ('Review Rating' requires 'Ultimate Reviews' to be installed)", 'UPCP')?></p>
		</fieldset>
	</td>
	</tr>
	<tr>
...
<table id='woocommerce-options' class="form-table upcp-options-table">
	...
	<td>
		...
		<p><?php _e("Should UPCP products be exported to WooCommerce, and WooCommerce products imported into UPCP? Products edited in one plugin will also be edited in the other while this is enabled.", 'UPCP')?><br />
		<?php _e("Using WooCommerce attributes or UPCP custom fields and want those to sync as well? Check out our blog post on how to <a href='http://www.etoilewebdesign.com/product-catalog-woocommerce-sync-tips/'>get the best syncing results for attributes</a>.", 'UPCP'); ?></p>
		</fieldset>
	</td>
	</tr>
	<tr>
	...
	<tr>
	<th scope="row"><?php _e("WooCommerce Back Link", 'UPCP')?> <br/>
	</th>
	<td>
		<fieldset><legend class="screen-reader-text"><span><?php _e("WooCommerce Back Link", 'UPCP')?></span></legend>
		<label title='Yes'><input type='radio' name='woocommerce_back_link' value='Yes' <?php if($WooCommerce_Back_Link == "Yes") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/> <span><?php _e("Yes", 'UPCP')?></span></label><br />
		<label title='No'><input type='radio' name='woocommerce_back_link' value='No' <?php if($WooCommerce_Back_Link == "No") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/> <span><?php _e("No", 'UPCP')?></span></label><br />
		<p><?php _e("Should the WooCommerce product page breadcrumbs be replaced with a 'Back to Catalogue' link when coming directly from the catalog page? WARNING: 'Maintain Filtering' (in the 'Basic' option tab) must be set to 'Yes'.", 'UPCP')?></p>
		</fieldset>
	</td>
	</tr>
</table>
