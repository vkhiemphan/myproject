...
function SingleProductPage() {
	...
	elseif ($Custom_Product_Page == "Tabbed") {
		...
		else {$Product_Details_Label = __("<span class='upcp-tab-break'>". __('Product', 'UPCP') . "</span> <span class='upcp-tab-break'>" . __('Details', 'UPCP') . "</span>", 'UPCP');}
		if (get_option("UPCP_Additional_Info_Label") != "") {$Additional_Info_Label = get_option("UPCP_Additional_Info_Label");}
		else {$Additional_Info_Label = __("<span class='upcp-tab-break'>" . __('Additional', 'UPCP') . "</span> <span class='upcp-tab-break'>" . __('Information', 'UPCP') . " </span>", 'UPCP');}
		if (get_option("UPCP_Contact_Us_Label") != "") {$Contact_Us_Label = get_option("UPCP_Contact_Us_Label");}
		else {$Contact_Us_Label = __("<span class='upcp-tab-break'>" . __('Contact', 'UPCP') . "</span> <span class='upcp-tab-break'>" . __('Us', 'UPCP') . "</span>", 'UPCP');}
		if (get_option("UPCP_Customer_Reviews_Tab_Label") != "") {$Customer_Reviews_Tab_Label = get_option("UPCP_Customer_Reviews_Tab_Label");}
		else {$Customer_Reviews_Tab_Label = __("<span class='upcp-tab-break'>" . __('Customer', 'UPCP') . "</span> <span class='upcp-tab-break'>" . __('Reviews', 'UPCP') . "</span>", 'UPCP');}
...
function BuildSidebar($category, $subcategory, $tags, $prod_name) {
	...
	else {$Rating_Ascending_Text = __('Rating (Ascending)', 'UPCP');}
	if ($Rating_Descending_Label != "") {$Rating_Descending_Text = $Rating_Descending_Label;}
	else {$Rating_Descending_Text = __('Rating (Descending)', 'UPCP');}
	if ($Product_Name_Search_Label != "") {$SearchLabel = $Product_Name_Search_Label;}
	else {
		if ($ProductSearch == "namedesc" or $ProductSearch == "namedesccust") {$SearchLabel = __("Product Search:", 'UPCP');}
		else {$SearchLabel = __("Product Name:", 'UPCP');}
...
function UPCP_Get_Reviews_HTML($Product_Name) {
    ...
    if ($Average_Rating != "") {
    	...
    	$ReturnString .= "<span class='upcp-urp-review-score' title='" . __("Average Rating: ", 'UPCP') . "0'></span>";
    }
